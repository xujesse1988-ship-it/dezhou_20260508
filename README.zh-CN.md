...
break-even——10,000 手 AIVAT 下 raw −85.25 / AIVAT −108.31 mbb/g，置信区间跨 0。当前那边的动作是
Slumbot 对战数据持续采集。详见 [`docs/heads_up_nlhe_solver_target.md`](./docs/heads_up_nlhe_solver_target.md)。
...
评测方式是对 OpenPoker 牌池的实战，因为没有够强的公开 6-max 参照 bot。
...
验收目标：[`docs/six_max_nlhe_target.md`](./docs/six_max_nlhe_target.md)。代码真实状态：
[`docs/status_v3.md`](./docs/status_v3.md)。
