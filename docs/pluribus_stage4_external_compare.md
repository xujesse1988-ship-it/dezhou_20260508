...
| Blueprint | Slumbot 100K mean (mbb/g) | 95% CI 下界 | 与 always-call 差距 |
|---|---|---|---|
| stage 4 first usable 10⁹（本报告）| [TBD] | [TBD] | [TBD] |
...
| LBR (HU) | < 100 mbb/g | [TBD]（预期 >> 100 mbb/g） | training scale 1000× gap |
| Slumbot HU | [N/A]（与 Slumbot 直接对比未公开） | [TBD] | — |
| baseline 3 类 | [implicit pass] | [TBD] | — |
